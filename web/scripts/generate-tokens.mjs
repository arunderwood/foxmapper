...
function existingTunedBlock() {
  ...
  return [
    ...
    "  /* The location estimate's outline and hatch (006 FR-024): near-black on the light map ground,",
    "     outside every per-callsign swatch, so the region never reads as anyone's report. */",
    '  --fx-color-estimate: #201A17;',
